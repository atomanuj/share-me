...
public class upload5 implements Runnable{
    Socket clientSocket;
    FileInputStream fStream;
    PrintWriter ctrlWriter;
    String pathOnClient;
    String pathOnServer;
    public upload5  (String pathOnClient, String pathOnServer , PrintWriter ctrlWriter , FileInputStream fStream , Socket clientSocket){
